    ...
    for file_num in elm_to_remove.keys():
        ...
        with open(text_file_path, mode='r', encoding='utf-8') as in_f:
            ...
            for reverse_seg in elm_to_reverse[file_num]:
                ...
                line_time_list[reverse_seg[0]:reverse_seg[1] + 1] = line_time_list[reverse_seg[0]:reverse_seg[1] + 1][::-1]
                line_device_list[reverse_seg[0]:reverse_seg[1] + 1] = line_device_list[reverse_seg[0]:reverse_seg[1] + 1][::-1]
